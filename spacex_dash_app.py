...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df[filtered_df['Launch Site']==entered_site].groupby(['class']).count(), values='Launch Site', 
        names=filtered_df[filtered_df['Launch Site']==entered_site].groupby(['class']).count().index, 
...
def get_pie_chart(entered_site, payload_mass):
    filtered_df = spacex_df
    if entered_site == 'ALL':
        fig = px.scatter(filtered_df[(filtered_df['Payload Mass (kg)']>=payload_mass[0]) & (filtered_df['Payload Mass (kg)']<=payload_mass[1])],
        x='Payload Mass (kg)',
        y='class',
        ...
        fig = px.scatter(filtered_df[(filtered_df['Launch Site']==entered_site) & (filtered_df['Payload Mass (kg)']>=payload_mass[0]) & (filtered_df['Payload Mass (kg)']<=payload_mass[1])],
        x='Payload Mass (kg)',
        y='class',
        color='Booster Version Category',
